...
while True:
    ...
    print("3. გატანა")               # ოფცია 3 — თანხის გატანა
...
choice = input("აირჩიე მოქმედება (1): ")     # 👉 მომხმარებლის მიერ არჩევანის შეყვანა
...
def withdraw(amount):                        # 👉 ფუნქცია თანხის გატანისთვის
    ...
    if 0 < amount <= balance:                # 👉 თუ თანხა მეტია 0-ზე და ნაკლებია ან ტოლი ბალანსზე
        ...
        print(f"{amount} ₾ გაიყვანეს")       # 👉 დაბეჭდოს შეტყობინება გატანაზე
    else:
        print("არასაკმარისი თანხა ან არასწორი თანხა")  # 👉 შეცდომის შეტყობინება

choice = input("აირჩიე მოქმედება (3 = გატანა): ")       # 👉 ეკითხება მხოლოდ 3 გატანაზე
